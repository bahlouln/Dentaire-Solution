// src/Components/dentiste/lists/ListePatients.jsx
...
export default function ListePatients() {
    ...
    const saveRow = async (id) => {
        ...
        setErrorMsg("");
        try {
            await axios.put(`http://localhost:5000/api/dentistes/patients/${id}`, formData, {
                headers: { Authorization: `Bearer ${user.token}` }
            });
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await axios.delete(`http://localhost:5000/api/dentistes/patients/${id}`, {
                headers: { Authorization: `Bearer ${user.token}` }
            });
        } catch (e) {
